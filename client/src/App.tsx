...
import { penProviderRegistry } from "./providers/registry";
import "./providers/gist";
...
const DEFAULT_HTML =
  ...
  `<img src="https://pen.themisir.com/pen.png" height="50" alt="Pen"/>` +
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    if (window.location.pathname.length > 0) {
      penProviderRegistry.getFiles(window.location.pathname).then((r) => {
        if (r && r.length) {
          const file = r[0];
